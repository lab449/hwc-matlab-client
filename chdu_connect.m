function chdu = chdu_connect()
    ...
    try
        ...
        websave('chdu_connect.m', 'https://hdu.vedyakov.com/files/hwc-matlab-client/chdu_connect.m');
        ...
        if ~check_hash
            websave('CHDU.m', 'https://hdu.vedyakov.com/files/hwc-matlab-client/CHDU.m')
